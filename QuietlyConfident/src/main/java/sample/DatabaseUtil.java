...
public class DatabaseUtil {
	...
	public final static String rdsMySqlDatabaseUrl = "newvideodb.cuw9jiolygdd.us-east-2.rds.amazonaws.com";
	public final static String dbUsername = "admin";
	public final static String dbPassword = "confident";
		
	public final static String jdbcTag = "jdbc:mysql://";
	public final static String rdsMySqlDatabasePort = "3306";
	public final static String multiQueries = "?allowMultiQueries=true";
	   
	public final static String dbName = "Video and Playlist DB";         // default created from MySQL WorkBench
